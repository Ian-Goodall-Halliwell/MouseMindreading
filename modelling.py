...
def optim(trial):
    ...
    hidden_size = trial.suggest_categorical('hidden_size',[16,32,64,128,256,512]) #trial.suggest_categorical('hidden_size',[32,64,128,256])  # Number of units in the hidden layer
...
study.optimize(optim)#,catch=[ValueError])